...
resource "aws_s3_object" "object" {
  ...
  source = "${path.module}/build/libs/g-hello-0.0.1-SNAPSHOT.jar"

  # The filemd5() function is available in Terraform 0.11.12 and later
  # For Terraform 0.11.11 and earlier, use the md5() function and the file() function:
  # etag = "${md5(file("path/to/file"))}"
  etag = filemd5("${path.module}/build/libs/g-hello-0.0.1-SNAPSHOT.jar")
}
    ...
    "Statement" : [
      {
        ...
        "Resource" : [
          "arn:aws:s3:::jim-tf-test-bucket1/g-hello-0.0.1-SNAPSHOT.jar",
          "arn:aws:s3:::jim-tf-test-bucket1"
        ]
      }
    ]
  })
